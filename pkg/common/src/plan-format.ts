/**
 * Tour-plan format + validation. A plan is a human-readable Markdown file whose
 * fenced ```json block is the machine-runnable TourScript — `rerun` extracts that
 * block, `demo` writes one out.
 */
